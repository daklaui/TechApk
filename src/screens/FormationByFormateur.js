...
import {getFormations } from '../services/formateurServices';
import Icon from 'react-native-vector-icons/FontAwesome';
import Item from '../components/Item';

const { width, heigth } = Dimensions.get('window');
class FormationByFormateur extends React.Component {
  ...
  fetchDeliveries = async () => {
    try {
      ...
      const data = await getFormations(this.context.user.id);
        ...
        {loading ? (
          ...
          />
            ...
            <FlatList
              ...
              renderItem={({ item }) => {
                return <TouchableOpacity onPress={() => this.props.navigation.navigate("ListSessionFormateur", { data: item.id })}><Item item={item} /></TouchableOpacity>
              }}
...
export default withTranslation()(FormationByFormateur);
